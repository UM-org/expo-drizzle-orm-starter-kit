...
const CleanGiftsModal: React.FC<CleanDbModalProps> = (props) => {
    const { truncate } = useGifts()
        ...
        >
            <View style={[style.centeredView]}>
                <View style={style.modalView}>
                    ...
                    <Text style={style.title}>Vous allez vider la liste des cadeaux.</Text>
...
export default CleanGiftsModal;
