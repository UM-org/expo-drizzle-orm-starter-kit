...
import { Button, InputGroup, TextInput } from '@/components/Themed';
...
const OpenSettingsModal: React.FC<OpenSettingsModalProps> = (props) => {
    ...
    const onSubmit = useCallback(() => {
        if (code != process.env.EXPO_PUBLIC_ADMIN_CODE) {
                ...
                <View style={style.modalView}>
                    ...
                    <KeyboardAvoidingView style={style.formContainer} behavior="position">
                        <ScrollView style={{ padding: 10, minWidth: 270 }}>
                            ...
                            <Button onPress={onSubmit} style={[{ flex: 0.7, minWidth: 120, paddingHorizontal: 10, paddingVertical: 15, marginHorizontal: 15, justifyContent: "center", }]}>
                                <Text style={{ color: Colors.light.text, fontWeight: "700" }}>Valider</Text>
                            </Button>
                        </ScrollView>
